...
2. С помощью doxywizard откройте файл DoxyAutoDoc
...
Сами юнит тесты представляют собой набор из сложных слов, которыt заданы в слоте с данными, который предоставляется для каждого тестирующего слота. Запуск тестовых функций происходит с помощью макроса QTEST_MAIN(). Тесты запускаются автоматически при компиляции проекта.
